package com.authoriza.shared.infrastructure.bus.command;
...
import com.authoriza.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections reflections = new Reflections("com.authoriza");
